...
import { BookOpen, Calendar, ChevronRight, FileText, Tag, Eye, Layers } from "lucide-react";
...
export const SearchDocumentCard: React.FC<SearchDocumentCardProps> = ({ source }) => {
  ...
  return (
    <>
      <Card className="flex flex-col overflow-hidden transition-all duration-200 border rounded-xl shadow-md md:flex-row group bg-gradient-to-b from-white to-muted/5 hover:shadow-lg hover:border-primary/20">
        ...
        <div className="flex flex-col flex-1 min-w-0 gap-4 p-6">
          ...
          <div className="mt-1 bg-white p-4 rounded-lg shadow-sm">
            <Markdown
          ...
          <div className="grid grid-cols-1 gap-4 p-6">
            {source.contents && source.contents.length > 0 ? (
              source.contents.map((content, idx) => (
                <div
                  key={idx}
                  className="p-4 transition-all duration-200 border rounded-lg bg-gradient-to-br from-white to-muted/5 hover:bg-muted/10 hover:border-primary/20 shadow-sm"
                >
...
export const SearchDocumentCardSkeleton = () => {
  return (
    <Card className="flex flex-col overflow-hidden border rounded-xl shadow-md md:flex-row bg-gradient-to-b from-white to-muted/5">
